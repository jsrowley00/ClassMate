  ...
  return (
    <div className="p-6 md:p-8 max-w-5xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Get personalized recommendations across all your courses</p>
      </div>
      ...
      <Card className="flex flex-col h-[600px]">
        <CardHeader className="border-b">
          <CardTitle className="flex items-center justify-between">
            ...
            <Badge variant="secondary" className="gap-1.5" data-testid="badge-cross-course">
              <Sparkles className="h-3.5 w-3.5" />
              Cross-Course Aware
            </Badge>
          </CardTitle>
          <p className="text-sm text-muted-foreground mt-2">
            I can see your progress across all courses and recommend which course to focus on next
          </p>
        </CardHeader>
              ...
              <div className="h-full flex items-center justify-center text-center">
                <div>
                  ...
                  <p className="text-muted-foreground max-w-md">
                    I can see your progress across all your courses and help you decide which course to focus on next. Try asking "What should I study next?" or "Which course needs my attention?"
                  </p>
                </div>
              </div>
            )}
          ...
          <div className="border-t p-4">
            <div className="flex gap-2">
              <Textarea
                ...
                placeholder="Ask which course to study next..."
